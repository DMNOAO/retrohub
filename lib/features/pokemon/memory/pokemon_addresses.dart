final class PokemonMemoryAddresses {
  ...
  PokemonMemoryAddresses shifted(int delta) => PokemonMemoryAddresses(
    ...
    otherTrainerClass: otherTrainerClass == null ? null : otherTrainerClass! + delta,
  ...
  static const goldSilver = PokemonMemoryAddresses(
    ...
    battleMode: 0x1116, otherTrainerClass: 0x1118, battleResult: 0x0FE9,
  ...
  static const crystal = PokemonMemoryAddresses(
    ...
    pokedexOwned: 0x1E99, pokedexSeen: 0x1EB9,
    ...
    battleMode: 0x122D, otherTrainerClass: 0x122F, battleResult: 0x10EE,
