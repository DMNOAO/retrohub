...
class TrainerClassResolver {
  ...
  static const Map<int, TrainerClassInfo> _classes = <int, TrainerClassInfo>{
    ...
    0x16: TrainerClassInfo('Joven', 'assets/sprites/characters/trainers/gbc/youngster.png'),
    0x17: TrainerClassInfo('Colegial', 'assets/sprites/characters/trainers/gbc/schoolboy.png'),
    0x18: TrainerClassInfo('Ave-cuidador', 'assets/sprites/characters/trainers/gbc/bird_keeper.png'),
    0x19: TrainerClassInfo('Señorita', 'assets/sprites/characters/trainers/gbc/lass.png'),
    0x1A: TrainerClassInfo('Janine'),
    0x1B: TrainerClassInfo('Míster Genial', 'assets/sprites/characters/trainers/gbc/cooltrainer_male.png'),
    0x1C: TrainerClassInfo('Miss Genial', 'assets/sprites/characters/trainers/gbc/cooltrainer_female.png'),
    0x1D: TrainerClassInfo('Bella', 'assets/sprites/characters/trainers/gbc/beauty.png'),
    0x1E: TrainerClassInfo('Fanático Pokémon', 'assets/sprites/characters/trainers/gbc/pokemaniac.png'),
    0x1F: TrainerClassInfo('Rocket (M)'),
    0x20: TrainerClassInfo('Caballero', 'assets/sprites/characters/trainers/gbc/gentleman.png'),
    0x21: TrainerClassInfo('Esquiadora', 'assets/sprites/characters/trainers/gbc/skier.png'),
    0x22: TrainerClassInfo('Profesora', 'assets/sprites/characters/trainers/gbc/teacher.png'),
    0x23: TrainerClassInfo('Sabrina'),
    0x24: TrainerClassInfo('Cazabichos', 'assets/sprites/characters/trainers/gbc/bug_catcher.png'),
    0x25: TrainerClassInfo('Pescador', 'assets/sprites/characters/trainers/gbc/fisherman.png'),
    0x26: TrainerClassInfo('Nadador', 'assets/sprites/characters/trainers/gbc/swimmer_male.png'),
    0x27: TrainerClassInfo('Nadadora', 'assets/sprites/characters/trainers/gbc/swimmer_female.png'),
    0x28: TrainerClassInfo('Marinero', 'assets/sprites/characters/trainers/gbc/sailor.png'),
    0x29: TrainerClassInfo('Empollón', 'assets/sprites/characters/trainers/gbc/super_nerd.png'),
    0x2A: TrainerClassInfo('Rival (encuentro 2)'),
    0x2B: TrainerClassInfo('Guitarrista', 'assets/sprites/characters/trainers/gbc/guitarist.png'),
    0x2C: TrainerClassInfo('Excursionista', 'assets/sprites/characters/trainers/gbc/hiker.png'),
    0x2D: TrainerClassInfo('Motorista', 'assets/sprites/characters/trainers/gbc/biker.png'),
    0x2E: TrainerClassInfo('Blaine'),
    0x2F: TrainerClassInfo('Ladrón', 'assets/sprites/characters/trainers/gbc/burglar.png'),
    0x30: TrainerClassInfo('Lanzallamas', 'assets/sprites/characters/trainers/gbc/firebreather.png'),
    ...
    0x38: TrainerClassInfo('Sabio', 'assets/sprites/characters/trainers/gbc/sage.png'),
    0x39: TrainerClassInfo('Médium', 'assets/sprites/characters/trainers/gbc/medium.png'),
    0x3A: TrainerClassInfo('Snowboarder', 'assets/sprites/characters/trainers/gbc/snowboarder.png'),
    0x3B: TrainerClassInfo('Aficionado Pokémon (M)', 'assets/sprites/characters/trainers/gbc/pokefan_male.png'),
    0x3C: TrainerClassInfo('Chica Kimono', 'assets/sprites/characters/trainers/gbc/kimono_girl.png'),
