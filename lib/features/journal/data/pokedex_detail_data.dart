...
class PokedexDetailData {
  ...
  // RetroHub-specific Spanish presentation and encounter overrides. Structured
  // species data (251 entries, learnsets and TM/HM compatibility) lives in the
  // generated offline Crystal dataset.
  static const Map<int, PokedexSpeciesDetail> _crystalOverrides = {
    16: PokedexSpeciesDetail(encounters: [
    ...
    92: PokedexSpeciesDetail(encounters: [
