...
## Mednafen Supafaust libretro core

RetroHub distributes the Mednafen Supafaust libretro core for SNES emulation
on Android.
The core is licensed under the GNU General Public License, version 2. Its
source code and license are available from:

- https://github.com/libretro/supafaust

## Snes9x libretro core

RetroHub distributes the Snes9x libretro core for SNES emulation on Windows.
Its source code and license are available from:
