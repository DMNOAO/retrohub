; Fuente: https://github.com/pret/pokecrystal/blob/master/constants/map_constants.asm
; Pegado directamente por el usuario desde el repositorio real de pret.
; Los números de grupo y de mapa se toman de los comentarios inline
; (; N) que el propio archivo trae junto a cada `newgroup` y `map_const`,
; que son los valores reales que asignan las macros const_def/const_skip.
